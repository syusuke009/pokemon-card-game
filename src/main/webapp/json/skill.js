...
// "27_1":{"name":"すなかけ","cost":["fight"],"damage":"10","description":"「すなかけ」を受けた相手は、次の番に「ワザ」を使うときに、コインをなげ、「おもて」なら成功、「うら」なら「ワザ」は失敗する。","effect":"skill_27_1","timing":"after-damage"},
...
// "35_2":{"name":"ゆびをふる","cost":["normal","normal","normal"],"damage":"","description":"相手のワザの中から1つを選び、それを自分のワザとして使う。そのワザを使うのに必要なエネルギーがついていなくてもかまわないが、ほかに必要な条件(エネルギーカードをはがしてすてるなど)がたりないときには使えない。","effect":"skill_35_2","timing":"before-damage"},
// "36_1":{"name":"ゆびをふる","cost":["normal"],"damage":"","description":"相手のワザの中から1つを選び、それを自分のワザとして使う。そのワザを使うのに必要なエネルギーがついていなくてもかまわないが、ほかに必要な条件(エネルギーカードをはがしてすてるなど)がたりないときには使えない。","effect":"skill_36_1","timing":"before-damage"},
...
// "62_2":{"name":"うずしお","cost":["aqua","aqua","normal","normal"],"damage":"40","description":"相手の対戦ポケモンのエネルギーカードを1枚はがしてすてる。","effect":"skill_62_2","timing":"after-damage"},
...
// "72_2":{"name":"ようかいえき","cost":["leaf","leaf"],"damage":"20","description":"コインを投げて「おもて」なら、「ようかいえき」を受けた相手の対戦ポケモンは、次の相手の番に「にげる」ことができない。","effect":"skill_72_2","timing":"after-damage"},
